# -*- encoding: utf-8 -*-
# stub: bson_ext 1.12.5 ruby ext/bson_ext
...
Gem::Specification.new do |s|
  ...
  s.require_paths = ["ext/bson_ext".freeze]
  ...
  s.rubyforge_project = "bson_ext".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<bson>.freeze, ["~> 1.12.5"])
    else
      s.add_dependency(%q<bson>.freeze, ["~> 1.12.5"])
    end
  else
    s.add_dependency(%q<bson>.freeze, ["~> 1.12.5"])
  end
